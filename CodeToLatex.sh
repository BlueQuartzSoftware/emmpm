...
texFile=/tmp/EMMPM_PublicAffairs_Release.tex
cd "/Users/mjackson/Workspace/EIM-emmpm"
...
echo "\title{EMMPM Software Tools Package}" >> $texFile
echo "\author{Purdue University and Michael A. Jackson (BlueQuartz Software)}" >> $texFile
